...
* Use [DHTI](https://github.com/dermatologist/dhti) to generate a Conch package template. (`npx dhti-cli conch init -n <package-name>`)
* If you are vibe-coding, use [DHTI's](https://github.com/dermatologist/dhti) conch-generator skill.
...
1. [Fork the repo](http://help.github.com/fork-a-repo) and clone it to your local computer, and set up the upstream remote:
        ...
        git clone https://github.com/YourGithubUsername/openmrs-esm-dhti.git
        cd openmrs-esm-dhti
        git remote add upstream https://github.com/dermatologist/openmrs-esm-dhti.git
